...
// Added on 7th May for analytics
...
import { generatePDFReport } from '../utils/generatePDF';
import { generateCSV } from '../utils/generateCSV';
import Script from 'next/script'; // ✅ Added Plausible Script import
  ...
  return (
    <>
      ...
      <Script
        async
        defer
        data-domain="regnovaai.vercel.app" // 🔁 Replace with your live domain if needed
